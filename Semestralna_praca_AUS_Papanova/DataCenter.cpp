...
void DataCenter::loadTowns()
{
	...
	loader->loadTeritorialUnit(*district_, *township_, "../data/obce.csv", 0);
	...
	loader->loadInfo(*education_, *age_, "../data/vzdelanie.csv", "../data/vek.csv");
...
void DataCenter::loadDistricts()
{
	//loader->loadTeritorialUnit(*region_,*district_, "D:\\UNIZA\\letny DRUHAK\\AUS\\Semestralka\\AUS_Semestralna_praca\\okresy.csv",1);
		loader->loadTeritorialUnit(*region_,*district_, "../data/okresy.csv",1);
...
void DataCenter::loadTRegions()
{
	...
	loader->loadTeritorialUnit(*state_, *region_, "../data/kraje.csv", 2);
